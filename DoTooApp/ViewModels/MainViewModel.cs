...
namespace DoTooApp.ViewModels
{
    public class MainViewModel : ViewModel
    {
        ...
        {
            repository.OnItemAdded += (sender, item) => Items.Add((TodoItemViewModel)CreateTodoItemViewModel(item));
        ...
        private async Task LoadData()
        {
            ...
            Items = new ObservableCollection<TodoItemViewModel>((List<TodoItemViewModel>)itemViewModels);
        }

        private object CreateTodoItemViewModel(TodoItem item)
        {
